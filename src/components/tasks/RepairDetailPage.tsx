      ...
      <Skeleton loading={loading} active paragraph={{ rows: 6 }}>
        ...
        <Descriptions size="small">
          ...
          <Descriptions.Item label="ช่องทาง" span={3}>
            <Tag
              {...(task?.source?.color ? { color: task?.source?.color } : {})}
            >
              {task?.source?.nameTh}
            </Tag>
          </Descriptions.Item>
              ...
              <Flex vertical gap={8}>
                <Descriptions size="small" bordered>
                  ...
                  <Descriptions.Item label="รูปภาพ" span={3}>
                    <Tooltip
                      title={
                        detail.images?.length > 0 ? "มีรูปภาพ" : "ไม่มีรูปภาพ"
                      }
                    >
                      <FontAwesomeIcon
                ...
                <Descriptions size="small" bordered>
                  ...
                  <Descriptions.Item label="วันที่และเวลาจบงาน">
                    {detail.finishDate ? (
                      `${dayjs(detail.finishDate).format("DD/MM/YYYY")} ${dayjs(
                        detail.finishDate
                      ).format("HH:mm")} น.`
                    ) : (
                      <Tag color="default" bordered={false}>
                ...
                <Flex vertical gap={8}>
                  ...
                  <Descriptions size="small" bordered>
                    ...
                    <Descriptions.Item label="SLA">
                      {detail.sla?.SLA1H} ชั่วโมง หรือ {detail.sla?.SLA1D} วัน
                    </Descriptions.Item>
                    <Descriptions.Item label="ผู้รับผิดชอบ" span={3}>
                      {detail.homecare?.firstName} {detail.homecare?.lastName}
                    </Descriptions.Item>
